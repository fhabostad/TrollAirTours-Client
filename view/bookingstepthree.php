         ...
         <span> 4 </span> 
                        ...
                        <form id="bookingstepthreeform" action="?page=bookingFour" method="post">
                            <div id="form-left-column">
                                ...
                                <label>Birth date</label> <input id="Birthdate" type="date" name="givenBirth_date" value="<?php print "".$_SESSION['givenBirth_date']?>" placeholder="Enter birth date DD.MM.YYYYY" max="31.12.2000" min="1899-01-01" tabindex="4" required><br>  
