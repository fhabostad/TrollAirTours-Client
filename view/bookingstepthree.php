                    ...
                    <div id="main-top-overlay-booking">
                        ...
                        <form id="bookingstepthreeform" action="?page=bookingFour" method="post">
                            <div id="form-left-column">
                                ...
                                <label>Birth date</label> <input id="Birthdate" type="date" name="givenBirth_date" value="<?php print "".$_SESSION['givenBirth_date']?>" placeholder="Enter birth date MM-DD-YYYYY" max="2000-12-31" min="1899-01-01" tabindex="4" required><br>  
